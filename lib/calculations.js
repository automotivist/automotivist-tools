...
export function refiContext(oldRate, newRate) {
  ...
  return {
    ...
    when: `Run the numbers on your specific balance and remaining term. The rule of thumb: if total savings exceed $1,000 and breakeven is under 12 months, the refinance is worth the application time.`,
