...
export default function RefinancePage({ data, faqs, slug, oldRate, newRate }) {
  ...
  return (
    <Layout
      ...
      description={`Dropping your car loan APR from ${oldRate}% to ${newRate}% saves ${fmtS(sample25k.monthlySaving)}/month and ${fmtS(sample25k.totalSaving)} total on a $25,000 balance. See the full breakdown.`}
