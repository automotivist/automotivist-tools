      ...
      {/* Newsletter capture */}
              {editorial && (
                <div style={{ margin: '32px 0' }}>
                  ...
                  <div style={{ background: 'rgba(232,160,32,.06)', border: '1px solid rgba(232,160,32,.2)', borderRadius: 10, padding: '18px 22px' }}>
                    <p style={{ fontSize: 14, color: '#17140D', lineHeight: 1.8, margin: 0 }}>{editorial}</p>
                  </div>
                </div>
              )}
